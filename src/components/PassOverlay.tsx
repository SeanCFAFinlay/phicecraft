...
export function PassOverlay() {
  ...
  return (
    <div className="fixed bottom-36 left-1/2 -translate-x-1/2 bg-[rgba(6,14,22,0.95)] border-2 border-yellow-400 rounded-xl py-2 px-4 z-50 flex items-center gap-2.5 pointer-events-none shadow-lg">
      <div
